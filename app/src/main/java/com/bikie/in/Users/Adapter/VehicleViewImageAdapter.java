...
public class VehicleViewImageAdapter extends RecyclerView.Adapter<VehicleViewImageAdapter.ViewHolder> {
    Context context;
    ArrayList<String> arrayList;
    OnItemClickListener onItemClickListener;

    public VehicleViewImageAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.images_list_vehicle, parent, false);
